---- MODULE CLA_Generated_attempt_1_TTrace_1790012588 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CLA_Generated_attempt_1_TTrace_1790012588.json", _TETrace)
...
\*
\*trace == IODeserialize("CLA_Generated_attempt_1_TTrace_1790012588.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([mode |-> <<"RTC", "RTC", "RTC">>,motorStatus |-> ,latchPawlPosition |-> <<"latched", "unlatched", "unlatched">>,secondaryReleaseStatus |-> ])
    >>
----
...
---- CONFIG CLA_Generated_attempt_1_TTrace_1790012588 ----
CONSTANTS
    N = 3
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon Sep 21 19:43:09 CEST 2026