---- MODULE CLA_Generated_attempt_1_TTrace_1790011923 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CLA_Generated_attempt_1_TTrace_1790011923.json", _TETrace)
...
\*
\*trace == IODeserialize("CLA_Generated_attempt_1_TTrace_1790011923.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([mode |-> "RTC",motorStatus |-> "operational",latchPawlPosition |-> "latched",secondaryReleaseStatus |-> "inactive"]),
    ([mode |-> "RTR",motorStatus |-> ,latchPawlPosition |-> "unlatched",secondaryReleaseStatus |-> ])
    >>
----
...
---- CONFIG CLA_Generated_attempt_1_TTrace_1790011923 ----
CONSTANTS
    N = 3
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon Sep 21 19:32:03 CEST 2026