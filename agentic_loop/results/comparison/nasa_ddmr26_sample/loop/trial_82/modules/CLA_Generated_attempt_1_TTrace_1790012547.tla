---- MODULE CLA_Generated_attempt_1_TTrace_1790012547 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CLA_Generated_attempt_1_TTrace_1790012547.json", _TETrace)
...
\*
\*trace == IODeserialize("CLA_Generated_attempt_1_TTrace_1790012547.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG CLA_Generated_attempt_1_TTrace_1790012547 ----
CONSTANTS
    N = 3
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon Sep 21 19:42:27 CEST 2026