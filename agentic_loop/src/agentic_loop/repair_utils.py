...
def try_register_candidate_rule(candidate_rule, skills_db, pending_session_rule):
    """
    Registers candidate_rule into skills_db unless it's been tried for this error before.
